...
//	glFrontFace(GL_CW);
    ...
    printf("x pos %f\n",scaling*(-u1[0]*(1-lookAt[0])-u1[1]*(0-lookAt[1])-u1[2]*(-0+lookAt[2])));
    printf("y pos %f\n",scaling*(-u2[0]*(1-lookAt[0])-u2[1]*(0-lookAt[1])-u2[2]*(-0+lookAt[2])));
    printf("z pos %f\n",scaling*(-u3[0]*(1-lookAt[0])-u3[1]*(0-lookAt[1])-u3[2]*(-0+lookAt[2])));

	printf("x pos %f\n",scaling*(-u1[0]*(0-lookAt[0])-u1[1]*(1-lookAt[1])-u1[2]*(-0+lookAt[2])));
    printf("y pos %f\n",scaling*(-u2[0]*(0-lookAt[0])-u2[1]*(1-lookAt[1])-u2[2]*(-0+lookAt[2])));
    printf("z pos %f\n",scaling*(-u3[0]*(0-lookAt[0])-u3[1]*(1-lookAt[1])-u3[2]*(-0+lookAt[2])));

	printf("x pos %f\n",scaling*(-u1[0]*(0-lookAt[0])-u1[1]*(0-lookAt[1])-u1[2]*(-1+lookAt[2])));
    printf("y pos %f\n",scaling*(-u2[0]*(0-lookAt[0])-u2[1]*(0-lookAt[1])-u2[2]*(-1+lookAt[2])));
    printf("z pos %f\n",scaling*(-u3[0]*(0-lookAt[0])-u3[1]*(0-lookAt[1])-u3[2]*(-1+lookAt[2])));
